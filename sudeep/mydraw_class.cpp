...
//-----------------------
// 3. fill_t methods
fill_t::fill_t(color_t _current_fill_color) : current_fill_color(_current_fill_color) {std::cout<<"hi";};
void fill_t::draw(color_t _background_color, color_t line_color, color_t _fill_color, point_t** pixel_array, point_t node)
{
    //need to implement some fill algorithm
    // point_t node_original = node;
    // int base_y = node.getY();
    // int base_x = node.getX();
    // int x = base_x;
    // int y = base_y;
    // bool move_up = true;
    // bool move_down = true;
    ...
    // while(move_up)
    // {   
    //     point_t node_loop = pixel_array[y][x];
    //     int w = x;
    //     int e = x;
    //     int c = y;
    ...
    //     }
    //     if(pixel_array[y+1][x].checkIfSameColor(_background_color) && move_up)
    //         y++;
    //     else move_up = false;
    // }
    // x = base_x;
    ...
    //         pixel_array[y][var].set_point_color(_fill_color);
    //     }
    //     if(pixel_array[y-1][x].checkIfSameColor(_background_color) && move_down)
    //         y--;
    ...
    // while(!pixels.empty())
    // {
    //     point_t pixel_new = pixels[0];
    //     int x = pixel_new.getX();
    //     int y = pixel_new.getY();
    //     pixel_array[y][x].set_point_color(_fill_color);
    //     pixels.erase(pixels.begin());
    //     if(pixel_array[y+1][x].checkIfSameColor(_background_color) && !pixel_array[y+1][x].checkIfSameColor(_fill_color))
    //         pixels.push_back(pixel_array[y+1][x]);
    //     if(pixel_array[y-1][x].checkIfSameColor(_background_color) && !pixel_array[y-1][x].checkIfSameColor(_fill_color))
    //         pixels.push_back(pixel_array[y-1][x]);
    //     if(pixel_array[y][x+1].checkIfSameColor(_background_color) && !pixel_array[y][x+1].checkIfSameColor(_fill_color))
    //         pixels.push_back(pixel_array[y][x+1]);        
    //     if(pixel_array[y][x-1].checkIfSameColor(_background_color) && !pixel_array[y][x-1].checkIfSameColor(_fill_color))
    //         pixels.push_back(pixel_array[y][x-1]);
